    ...
    private runQueue = ()=>{
        setTimeout(()=>{
            ...
            client.post('statuses/update',{
                ...
                err.message ?? messageSlack(`Faucet tweet failed: ${err.message}`) 
...
export const processTweet = async  (tweet)=>{
    ...
    try {
        ...
        recipientHash[userId] = true
        const message = `Your Ether has been sent on the NEW nitro rollup testnet: https://goerli-rollup-explorer.arbitrum.io/tx/${transactionHash}.\r\n\r\n`
